...
<script>
	$(function() {
		...
		var juk=${pdto.juk};
		$("#su").spinner({
			min:1, max:10, spin:function(e,ui) { // 버튼이 클리되었을때 실행되는 함수
				var su2=ui.value;
				var jsprice=price*su2;
				var jshalinprice=(price-(price*halin/100))*su2;
				var jsjukprice=Math.ceil((jshalinprice)*(juk/100));
	...
	function scrollMove() {
		...
		if(st>=674) {
			...
			document.getElementById("allMenu").style.top="-8px";
		}
		else {
...
<body> <!-- product/productContent.jsp -->
	...
	<section id="first">
		...
		<div id="right">
			<div id="ptitle">
				...
				<div id="rightT">
					<a href="javascript:jjimOk('${pdto.pcode}')">
						<img id="img" src="../static/main/${jImg}" style="valign: middle; margin-left: 100px"> 
					</a>
				</div>
			</div>
			...
			<div id="pprice">
				<span id="input2"><fmt:formatNumber value="${pdto.halinPrice}" type="number"/></span>원
			</div>
			<div id="pbaeprice">
			...
			<div id="pbutton">
				...
				<input type="button" onclick="addCart()" value="장바구니" id="btn" style="valign: middle;"> 
