...
<main>
	<form name="gform" method="post" action="gumaeOk">
		...
		<section id="member"> <!-- 구매자 정보 -->
			<table>
				<caption> <span id="h3"> 구매자 정보 </span> </caption>
				<tr>
					<td width="200"> 이 름 </td>
					<td> ${mdto.name} </td>
				</tr>
		...
		<section id="product">
			<table>
				<caption><span id="h3"> 구매 상품 정보 </span></caption>
		...
		<section id="price">
			<table>
				<caption> <span id="h3"> 결제 정보 </span> </caption>
				<tr>
		...
		<section id="sudan">
			...
			<div id="sudanFirst">
				...
				<div>
					<input type="radio" name="sudan" value="1"  class="sudan" onclick="viewSub(1)"> 페이머니
					<div class="sub">
						0원
					</div>
				</div>
