...
public class ProductController {
	...
	public String gumae(HttpSession session,
	...
	public String jusoWrite(HttpServletRequest request,
			Model model)
	{
	...
	public String jusoWriteOk(BaesongDto bdto,Model model,
			HttpSession session)
	{
	...
	public @ResponseBody String chgPhone(HttpServletRequest request,
			HttpSession session)
	{
	...
	public String jusoUpdate(HttpServletRequest request,
			Model model)
	{
	...
	public String jusoUpdateOk(BaesongDto bdto,
			HttpSession session)
	{
		// 보안관련으로 세션을 보낼수도 있다
	...
	public String gumaeOk(GumaeDto gdto, HttpSession session)
	{
		...
		//System.out.println(gdto.getPcodes()[0]+" "+gdto.getPcodes()[1]+" "+gdto.getPcodes()[2]+" "+gdto.getPcodes()[3]);
