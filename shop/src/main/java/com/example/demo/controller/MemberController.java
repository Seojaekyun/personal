...
public class MemberController {
    ...
    public @ResponseBody int[] chgSu(HttpServletRequest request,
    		HttpSession session,
    		HttpServletResponse response)
    {
    ...
    public String jjimList(HttpSession session,
    		Model model)
    {
    ...
    /*
    @RequestMapping("/member/jumunList2")
    public String jumunList2(HttpSession session, Model model)
    {
    	return service.jumunList2(session,model);
    }
    
    @RequestMapping("/member/jumunList3")
    public String jumunList3(HttpSession session, Model model)
    {
    	return service.jumunList3(session,model);
    }
    */
    ...
    public String baeUpdate(HttpServletRequest request,HttpSession session
    		,Model model)
    {
