...
>>>>>>> branch 'master' of https://github.com/Seojaekyun/personal.git
	...
	public String jumunList(HttpSession session, Model model, HttpServletRequest request) {
		 ...
		 * mapAll.get(i).get("sudan"); mapAll.get(i).get("writeday"); } else {
		 * 
		 * }
		 * 
	 ...
	 * switch(state) { case "0": stateMsg="결제완료"; break; case "1": stateMsg="상품준비중";
	 * break; case "2": stateMsg="배송중"; break; case "3": stateMsg="배송완료"; break;
	 * case "4": stateMsg="취소완료"; break; case "5": stateMsg="반품신청"; break; case "6":
	 * stateMsg="반품완료"; break; case "7": stateMsg="교환신청"; break; case "8":
	 * stateMsg="교환완료"; break; default: stateMsg="문의바람"; }
	 * mapAll.get(i).put("stateMsg", stateMsg); }
	 * 
	 * 
