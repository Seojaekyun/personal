...
<%@page import="kr.co.apensions.util.Utils" %>
...
<body> <!-- index.jsp -->
	...
	<header> 
		<div id="left"> <a href="../main/index"> <img src="../resources/Alogo6.png" width="50%" valign="middle"> </a> </div>
		<div id="right"> 
	...
	<footer>
		<table width="1000" align="center">
			<tr>
				...
				<td rowspan="5"><img alt="logo" src="../resources/Alogo3.png" width="80" align="middle"></td>
				<td> 상호명 : 어펜션스 </td>
				<td> 365고객센터 </td>
			</tr>
			<tr>
